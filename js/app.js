...
//<burger>====================================================================================================
let burger = document.querySelector('.navigation-header__icon-menu');
let list = document.querySelector('.navigation-header__list');
let body = document.querySelector('body');

burger.addEventListener("click", classActive);
...
//</burger>====================================================================================================
//</Tabs>====================================================================================================
let tabsColor = document.querySelectorAll('.tabs__item');
let tabsBlock = document.querySelectorAll('.tabs__block');
tabsColor.forEach(element => {
	element.addEventListener("click", function (e) {
		tabsColor.forEach(element => {
			element.classList.remove("active")
			let elem = Number(element.id)
			tabsBlock[elem].classList.remove("active");
		});
		element.classList.toggle("active");
		let elem = Number(element.id)
		tabsBlock[elem].classList.toggle("active");
	});
});
//</Tabs>====================================================================================================
//</Slider>====================================================================================================
...
//</Slider>====================================================================================================
//</Proofed block>====================================================================================================
let titlesActive = document.querySelectorAll('.column-left__titles');
let blockActive = document.querySelectorAll('.column-left__block');
let imgActive = document.querySelectorAll('.column-right__img');

titlesActive.forEach(element => {
	element.addEventListener("click", function (e) {
		titlesActive.forEach(element => {
			element.classList.remove("active")
			imgActive[element.id].classList.remove("active");
			blockActive[element.id].classList.remove("active");
		});
		element.classList.toggle("active");
		// let elem = element;
		// let id = element.id
		imgActive[element.id].classList.toggle("active");
		blockActive[element.id].classList.toggle("active");
	});
});
// blockActive.forEach(element => {
// 	element.addEventListener("click", function (e) {
// 		blockActive.forEach(element => {
// 			element.classList.remove("active")
// 		});
